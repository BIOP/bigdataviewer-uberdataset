...
public class SetupLoaderConvert {
    ...
    /**
     * Converts a BasicSetupImgLoader to a MultiResolutionSetupImgLoader by setting default function implementation
     * @param loader
     * @param <T>
     * @return
     */
    ...
    /**
     * Converts a SetupImageLoader to a ViewerSetupImgLoader by wrapping views into Volatile views, whenever possible
     * @param t Numeric Type
     * @param v Volatile Type
     * @param loader ImageLoader
     * @param mrsil Multiresolution Image Loader
     * @param <T>
     * @param <V>
     * @return the converter SetupImageLoader
     */
