...
/**
 * Uber dataset setup loader, for uber datasets
 * Setup loaders are converted into ViewerSetupImgLoader (for volatile display)
 * And multiresolution setup loader (with only one level)
 * These conversion looked necessary for proper setup loader handling, maybe there's some magic generic tricks in Java
 * which can relax these constrains, but I could not find it
 * @param <T>
 * @param <V>
